...
public class NLP {
    ...
    public static List<String> getEntitiesFromText(String text, String PathFile) throws IOException {

        String[] textStr = text.split(",");
        List<String> entities = new ArrayList<String>();

        TokenNameFinderModel modelPerson = new TokenNameFinderModel(NLP.class.getResourceAsStream(PathFile));
    ...
    public static List<String> getSintaxisSentence(String text, String PathFile){
        InputStream modelIn = null;
        List<String> words = new ArrayList<String>();

        try {
            modelIn = NLP.class.getResourceAsStream(PathFile);
            ...
            for(int i = 0; i < wordsTags.length; i++){
                words.add(wordsTags[i]);
                System.out.print(" " + wordsTags[i]+ " ");
            }
            System.out.println();
